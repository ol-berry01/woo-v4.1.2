...
class gcwoo_Pricing extends WP_Widget{
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_attr__( 'gcwoo - Pricing widget', 'gcwoo' ), // Name
            array( 
                'description' => esc_attr__( 'Display a pricing list.', 'gcwoo' ),
            )
        );
    }
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('currency'); ?>"><?php esc_html_e( 'Currency', 'gcwoo' ); ?> <small><?php esc_html_e( 'Example: $', 'gcwoo' ); ?></small></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('price'); ?>"><?php esc_html_e( 'Price', 'gcwoo' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('duration'); ?>"><?php esc_html_e( 'Duration', 'gcwoo' ); ?> <small><?php esc_html_e( 'Example: mo', 'gcwoo' ); ?></small></label><br/>
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('features'); ?>"><?php esc_html_e( 'Features List', 'gcwoo' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('link'); ?>"><?php esc_html_e( 'Link URL', 'gcwoo' ); ?></label><br/>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('featured'); ?>"><?php esc_html_e( 'Featured?', 'gcwoo' ); ?></label><br/>
