...
add_action('admin_enqueue_scripts', 'gcwoo_client_widget_scripts');

function gcwoo_client_widget_scripts(){

    wp_enqueue_media();

    wp_enqueue_script( 'gcwoo_client_widget_script', get_template_directory_uri() . '/js/widget.js', false, '1.0', true );

}


class gcwoo_Client extends WP_Widget{
    ...
    function __construct() {
        parent::__construct(
            ...
            esc_attr__( 'gcwoo - Client widget', 'gcwoo' ), // Name
            array( 
                'description' => esc_attr__( "Display a Client's logo.", 'gcwoo' ),
            )
        );
    }
