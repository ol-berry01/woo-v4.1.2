    ...
    <div class="row">
        ...
        <div class="row wow fadeInUp">
            ...
            <div class="row fleetcar-text wow fadeInUp" style="margin-bottom:2.5%">
                <h1 class="section-title"><?php the_sub_field('section_iv_details_title'); ?></h1>
                ...
                <div class="nav-iv-section">
                    <div class="nav-wrapper">
                        <a class="nav-link" href="<?php the_sub_field('col_iv_details_link'); ?>">
                            ...
                            <h2><?php the_sub_field('nav_iv_details_title'); ?></h2>
                                ...
                                <div class="nav-colours">
                                    <ul>
                                        <?php if( have_rows('nav_iv_details_colour') ): ?>
                                            ...
                                            <?php endwhile; ?>
                                        <?php endif; ?>
                                        <li style="width:auto;"><a style="color:#000048;" href="<?php the_sub_field('col_iv_details_link'); ?>">More Colours</a></li>
                                    </ul>
                                </div>
                            </div>
                        <!-- End: Details -->
