...
<?php endif; ?>
            ...
            <div id="product-image" class="product-image">
                <!-- Image Text -->
                <div class="product-image-text wow fadeInLeft">
                    <h2 class="product-image-text-title wow"><?php the_sub_field('builder_image_title'); ?></h2>
                ...
                <!-- End: Image Text -->
                <!-- Image -->
                <div class="product-image-wrap wow fadeInRight">
