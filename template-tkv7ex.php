		...
		<div id="container" class="container">
			...
			<div id="product-image" class="product-image">
				...
				<div class="product-image-text wow fadeIn">
					<h2 class="product-image-text-title wow fadeIn">Textron Fleet Management TKV 7EX</h2>
					<p class="wow fadeIn" data-wow-delay="300ms">7″ brilliant, sunlight-visible, touch-screen display and all the features you’ve come to expect from a top of the line GPS for Golf product.
					</p>
					<ul>
						<li>7” Ultra-bright touchscreen display</li>
...
-->
				...
				<div class="product-image-wrap wow fadeIn">
					<img src="<?php bloginfo('stylesheet_directory'); ?>/images/tkv-7ex.jpg" style="max-width:100%;" title="TKV 7EX" alt="Textron Fleet Management TKV 7EX GPS System">
				</div>
				<!-- End: Image -->
			</div>
		<!-- Image-section -->
						...
						<div>
							<!-- Nav tabs -->
								<ul class="nav nav-tabs" role="tablist">
									...
									<li role="presentation"><a data-target="#warranty" aria-controls="testimonials" role="tab" data-toggle="tab">Warranty</a></li>
								</ul>
							<!-- End: Nav Tabs -->
							<!-- Tab panes -->
