...
gcwoo is a multipurpose theme, focus on corporate and business. With responsive and minimalist design. Includes an awesome One Page design for the front page, with unique section to present your content, like Services, Features, Team members, Videos, Images, Testimonials, Pricing tables, Clients, Blog posts and much more. If you need more features you should check the PRO version, gcwoo Pro: https://www.quemalabs.com/theme/gcwoo-pro/
...
* How to Edit Front Page sections
All options are in "Admin Panel > Customize > Fron Page Sections".
You will find all the necessary option to edit the sections.

* How to get the PRO version of gcwoo
The PRO version is called "gcwoo" and includes tons of more features. You can buy it here:
https://www.quemalabs.com/theme/gcwoo-pro/


== Credits ==

gcwoo WordPress Theme, Copyright 2015 Nicolas Andrade
gcwoo is distributed under the terms of the GNU GPL
...
gcwoo WordPress Theme bundles the following third-party resources:
